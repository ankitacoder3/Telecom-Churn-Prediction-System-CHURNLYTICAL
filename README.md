...
The dataset used for this project can be found [here](https://github.com/ankitacoder3/CHURNLYTICAL/Telecom-Churn-Predictor/blob/main/WA_Fn-UseC_-Telco-Customer-Churn.csv), and it contains the necessary information for training and testing the churn prediction models.
